...
const BottomSheetDetailProject = forwardRef((props, ref) => {
  ...
  const renderItems = ({item, index}) => (
    <TouchableOpacity
      ...
      {props.isYear ? (
        ...
        <Text style={{color:selectItem === item ? '#597EF7' : '#595959'}}>
      ...
      {selectItem === item ? (
        <Image
          source={images.check}
          style={{width: Sizes.h16, height: Sizes.h16, resizeMode: 'contain'}}
        />
      ) : null}
    </TouchableOpacity>
  );
...
export default BottomSheetDetailProject;
BottomSheetDetailProject.defaultProps = {
